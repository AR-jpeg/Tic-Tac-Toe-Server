...
def handleClient(conn: socket.socket, addr):
    ...
    sendMsg("What game would you like to join? Please enter the Game ID: ", conn, 1)
    ...
    if not foundgameID:
        sendMsg(f"Couldn't find a game with the ID {gameID}, do you want to create a new game?", conn, 1)
